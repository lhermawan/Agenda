                        ...
                        <div class="header-column">
                            <div class="header-row">
                                <div class="header-logo">
                                    <a href="{{ route('home') }}">
                                        <img alt="Porto" width="50" height="62" src="{{ URL::to('images/logo-imi.png') }}">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="header-column justify-content-end">
                            <div class="header-row">
                                            ...
                                            <ul class="nav nav-pills" id="mainNav">
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{ route('post_page') }}">Gallery</a></li>
                                                        {{-- <li><a class="dropdown-item " href="shop-cart.html" >Login</a></li> --}}
                                ...
                                <div class="header-nav-features header-nav-features-light header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2">
                                    <a class="button1 font-weight-semibold text-3 btn-px-4 btn-py-1 order-1 order-lg-2 d-none d-md-block mr-3 mr-lg-0" data-hash data-hash-offset="65"  style="font-size: 13px;"  href="{{ URL::to('login') }}" >Login</a>
